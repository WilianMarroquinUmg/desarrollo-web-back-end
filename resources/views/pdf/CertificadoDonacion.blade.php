...
<main>
    <section style="margin: 40px; font-family: 'Times New Roman', serif; font-size: 18px; line-height: 1.6;">
        ...
        <p style="margin-top: 20px;">
            I. Declara el Sr. Juan José Garrido, que es propietario de la paja de agua identificada con el número
            Paja-2024-1, ubicada en el Barrio Las Joyas, obtenida por medio de compra al Sr. Rocael Mariano. Esta
            operación se acredita con el documento emitido con fecha 12 de diciembre de 2023, y validado por el COCODE
            comunitario a través del Sr. Óscar Marroquín.
        </p>

        <p style="margin-top: 20px;">
            II. Declara el Sr. Carlos Mejía, que acepta y está conforme con la adquisición de la paja de agua
            mencionada, ubicada en el Barrio Las Joyas, y manifiesta que realiza esta operación con pleno conocimiento
        ...
        <div class="firma" style="margin-top: 40px;">
            <div style="float: left; width: 45%; text-align: center;">
                ...
                <strong style="font-size: 18px;">Nombre y firma del Comprador</strong>
            </div>


            <div style="float: right; width: 45%; text-align: center;">
                F.________________________________________<br/>
                <strong style="font-size: 18px;">Nombre y firma del Vendedor</strong>
            </div>
        </div>
